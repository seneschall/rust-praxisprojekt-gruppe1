...
pub fn setup_digraph(filename: &str) -> Digraph<u32, u32> {
    ...
    let digraph: Digraph<u32, u32> = Digraph::from_adjacency_list(v_count, e_count, adj); // temporary new2 to create Digraph with adj list
    digraph
}
