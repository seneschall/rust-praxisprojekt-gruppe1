    ...
    L: Eq + Hash + Clone,
{
    fn outgoing_edges(&self, vertex: L) -> Vec<L> {
        ...
        for item in self.dg.outgoing_edges(vertex_index.unwrap().clone()) {
    ...
    fn incoming_edges(&self, vertex: L) -> Vec<L> {
        ...
        for item in self.dg.incoming_edges(vertex_index.unwrap().clone()) {
    ...
    fn delete_outgoing_edges(&mut self, vertex: L) {
        ...
        self.dg.delete_outgoing_edges(vertex_index.unwrap().clone());
    }
    ...
    fn delete_incoming_edges(&mut self, vertex: L) {
        ...
        self.dg.delete_incoming_edges(vertex_index.unwrap().clone());
    }
}
    ...
    L: Eq + Hash + Clone,
{
    fn add_edge(&mut self, from: L, to: L) {
        ...
        self.dg
            .add_edge(from_index.unwrap().clone(), to_index.unwrap().clone());
    }
}
